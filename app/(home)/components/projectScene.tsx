        ...
        <div className="h-screen w-screen bg-project bg-cover bg-center lg:bg-[length:100vw_100vh] bg-fixed relative">
            ...
            <div className="px-6 sm:px-10 lg:px-20 h-screen w-screen flex flex-col sm:flex-row justify-center items-center sm:gap-[8vw]">
                <div className="order-1 sm:order-2 relative text-white h-[40vh] flex justify-center items-center cursor-pointer "
                    ...
                    <div className={`text-[20vw] sm:text-[9.4vmax] ${isHover ? 'opacity-100' : 'opacity-0'} transition-opacity  text-transparent bg-clip-text  bg-gradient-to-r from-[white] via-[#b4f1d1] to-[#fffb87db]  `}>Project</div>
                    <div className={`absolute flex justify-center items-center h-[40vh] text-[30vw] sm:text-[11.2vmax] [clip-path:inset(_0_0_50%_0)] ${isHover ? '-translate-y-[8vw] sm:-translate-y-[3.8vmax]' : 'translate-y-1'} transition-transform text-transparent bg-clip-text  bg-gradient-to-r from-[white] via-[#b4f1d1] to-[#fffb87db]  `}>项目</div>
                    <div className={`absolute flex justify-center items-center h-[40vh] text-[30vw] sm:text-[11.2vmax] [clip-path:inset(_50%_0_0_0)] ${isHover ? 'translate-y-[8vw] sm:translate-y-[3.8vmax]' : 'translate-y-0'} transition-transform text-transparent bg-clip-text  bg-gradient-to-r from-[white] via-[#b4f1d1] to-[#fffb87db]  `}>项目</div>
                </div>

                <div className="order-2 sm:order-1 relative text-white text-[12.5vw] sm:text-[7vmax] [text-shadow:_0.5vw_0.5vw_0.2vw_violet] ">
                    <p>- 3D医疗 -</p>
                    <p>- 今何啖兮 -</p>
                    <p>- 选课系统 -</p>
                    <p>- 旅行物语 -</p>
