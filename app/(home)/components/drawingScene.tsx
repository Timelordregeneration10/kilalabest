        ...
        <div className="h-screen w-screen bg-drawing bg-cover bg-center lg:bg-[length:100vw_100vh] bg-fixed relative">
            ...
            <div className="px-6 sm:px-10 lg:px-20 h-screen w-screen flex flex-col sm:flex-row justify-center items-center sm:gap-[8vw]">
                <div className="relative text-white h-[40vh] flex justify-center items-center cursor-pointer "
                    ...
                    <div className={`text-[20vw] sm:text-[9.4vmax] ${isHover ? 'opacity-100' : 'opacity-0'} transition-opacity  text-transparent bg-clip-text  bg-gradient-to-r from-[white] via-[#f1b4f1] to-[#65adffbe]  `}>Drawing</div>
                    <div className={`absolute flex justify-center items-center h-[40vh] text-[40vw] sm:text-[22.4vmax] [clip-path:inset(_0_0_50%_0)] ${isHover ? '-translate-y-[8vw] sm:-translate-y-[3.8vmax]' : 'translate-y-1'} transition-transform text-transparent bg-clip-text  bg-gradient-to-r from-[white] via-[#f1b4f1] to-[#65adffbe]  `}>画</div>
                    <div className={`absolute flex justify-center items-center h-[40vh] text-[40vw] sm:text-[22.4vmax] [clip-path:inset(_50%_0_0_0)] ${isHover ? 'translate-y-[8vw] sm:translate-y-[3.8vmax]' : 'translate-y-0'} transition-transform text-transparent bg-clip-text  bg-gradient-to-r from-[white] via-[#f1b4f1] to-[#65adffbe]  `}>画</div>
                </div>
