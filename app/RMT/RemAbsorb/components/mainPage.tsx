...
interface RemAbsorbPageProps {
  iRemAbsorbInstuctionReaded: string | undefined;
}

const RemAbsorbPage: React.FC<RemAbsorbPageProps> = ({
  iRemAbsorbInstuctionReaded,
}) => {
  const [RemAbsorbInstuctionReaded, setRemAbsorbInstuctionReaded] = useState<
    string | undefined
  >(iRemAbsorbInstuctionReaded);
      ...
      {gameState === 0 && (
        <div className="relative w-screen h-screen text-[3vmax] overflow-hidden flex justify-center items-center">
          ...
          <div
            ...
            onClick={() => {
              setRemAbsorbInstuctionReaded(undefined);
            }}
          >
            instructions
          </div>
        ...
        >
          <ModalContent>
            ...
            <ModalBody className="text-xl font-light">
              ...
              <p>
                3.
                不同难度区域的出现速度不同，区域大小不同，留存时间不同，区域分数不同。
              </p>
              <p>
                4.
            ...
            <ModalFooter>
              <Button
                ...
                onPress={() => {
                  ...
                  setRemAbsorbInstuctionReaded("yes");
                }}
              >
                OK
              </Button>
